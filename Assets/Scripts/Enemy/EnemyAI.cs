...
public class EnemyAI : MonoBehaviour
{
        ...
        switch (_state)
        {
            ...
            case EnemyState.Idle:
                ...
                // 超过检测范围时输出距离（每秒一次，避免刷屏）
                    ...
                    GameLog.Log($"[EnemyAI] {name} Idle: 玩家距离={dist:F1}m, 检测范围={_detectRadius}m");
                break;
    ...
    /// </summary>
    private IEnumerator TryDealDamage()
    {
